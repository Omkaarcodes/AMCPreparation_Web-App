            ...
            <div className="p-6 md:p-8">
              <div className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <Button 
                    variant="outline" 
                    className="w-full shadow-md hover:shadow-lg transform hover:scale-[1.02] transition-all duration-200 border-gray-200 hover:border-gray-300 hover:bg-gray-50"
                  >
